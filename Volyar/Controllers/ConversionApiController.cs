...
namespace Volyar.Controllers
{
    ...
    public class ConversionApiController : Controller
    {
            ...
            {
                {
                    ...
                    {
                        new ConversionItem("SomeLibrary", "The TEST", "Test #1", "/home/test/vid/vid1.mkv", "/home/output/", "testitem", quality, 24, null, null),
                        new ConversionItem("SomeLibrary", null, null, "/home/test/vid/vid2.mkv", "/home/output/", "testitem2", quality, 24, null, null)
                    }
                },
                {
                    "processing",
                    new List<ExportableConversionItem>()
                    {
                        new ConversionItem("SomeLibrary", "The TEST", "Test #3","/home/test/vid/vid3.mkv", "/home/output/", "processItem", quality, 24, null, null)
                        {
                        ...
                        new ConversionItem("SomeLibrary", null, null, "/home/test/vid/vid4.mkv", "/home/output/", "processItem2", quality, 24, null, null)
                        {
                            Progress = new List<DescribedProgress>()
                            {
                        ...
                        new ConversionItem("SomeLibrary", null, null, "/home/test/vid/vid5.mkv", "/home/output/", "processItem3", quality, 24, null, null)
                        {
                            Progress = new List<DescribedProgress>()
                            {
                                new DescribedProgress("Encoding", 1),
        ...
        public IActionResult TestCompletedItems()
        {
            ...
            {
                new ConversionItem("SomeLibrary", "The COMPLETE", "Test #6", "/home/test/vid/vid6.mkv", "/home/output/", "completeitem1", quality, 24, null, null),
                new ConversionItem("SomeLibrary", "The FAILED", "Test #7", "/home/test/vid/vid7.mkv", "/home/output/", "completeitem2", quality, 24, null, null)
                {
