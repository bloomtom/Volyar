...
namespace Volyar.Controllers
{
    ...
    public class ConversionApiController : Controller
    {
        ...
        public IActionResult TestCompletedItems()
        {
            ...
            {
                new ConversionItem("The COMPLETE", "Test #6", "/home/test/vid/vid6.mkv", "/home/output/", "completeitem1", quality, 24, null, null),
                new ConversionItem("The FAILED", "Test #7", "/home/test/vid/vid7.mkv", "/home/output/", "completeitem2", quality, 24, null, null)
                {
